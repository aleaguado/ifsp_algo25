...
# Através do método grid() anexamos os componentes na tela por linha e coluna
rotulo_instrucao.grid(column=0, row=0, sticky="nsew") #anexamos o rótul
entrada_nome.grid(column=0, row=1, sticky="nsew") #anexamos o campo de digitação
bt.grid(column=1, row=0, rowspan=2, sticky="nsew") #anexamos o botão
rotulo_resultado.grid(column=0, row=3, columnspan=2, sticky="nsew") #anexamos o último rótulo
